...
class Anaekran(QMainWindow,Ui_AnaEkran):
    ...
    def karsilama(self):
        self.setupUi(self)
        self.actionKitap_Ekleme.triggered.connect(self.kitap_ekle)
        self.actionKitap_Listeleme.triggered.connect(self.kitap_listele)
        self.actionSilme.triggered.connect(self.kitap_silme)
        self.actionKitap_G_ncelleme.triggered.connect(self.kitap_guncelle)
